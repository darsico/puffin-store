  ...
  return (
    <Layout name="Iniciar Sesión en tu cuenta">
      <section className="max-w-md mx-auto py-10">
        ...
        <button type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-normal  justify-center  items-center py-2.5 text-center gap-2 flex dark:focus:ring-[#4285F4]/55 w-full">
          <BsGoogle /> Inicia sesión con Google
        </button>
