...
const CheckoutLayout = ({ children, title, description }) => {
  ...
  return (
    <>
      ...
      <header className=" fixed top-0 left-1/2 transform -translate-x-1/2  z-30 w-full ">
        <section className=" flex items-center justify-between lg:px-4 px-2  py-3 md:py-5 mx-auto  lg:w-[1024px] w-[95%] ">
          <div className="z-30 flex items-center justify-between w-full">
            ...
            <div className=" absolute top-0 left-0 w-full md:h-[220px] h-[150px]">
              <video className="w-full h-full object-cover" autoPlay muted src={'https://res.cloudinary.com/dhp1q5rxn/video/upload/v1660081497/checkout-assets/surf_szakjk.mp4'}></video>
            </div>
          </div>
        </section>
      </header>
